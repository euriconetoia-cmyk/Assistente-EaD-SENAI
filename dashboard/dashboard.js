...
async function appendAuditEvent(event) {
  const item = { schemaVersion: 1, eventId: `aud_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`, createdAt: new Date().toISOString(), extensionVersion: '3.7.4', environment: '', courseId: '', courseName: '', ucName: '', activityId: '', activityName: '', result: 'info', counts: {}, source: 'dashboard', message: '', ...event };
