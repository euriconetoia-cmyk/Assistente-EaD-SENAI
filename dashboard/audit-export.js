...
(() => {
  ...
  const buildFiles = async ({ events, payload, filters = {}, includeAcademic = false }) => {
    ...
    const manifest = { schemaVersion: 1, generatedAt, extensionVersion: '3.7.4', complete: true, files: items };
